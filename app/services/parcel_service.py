...
VALID_TRANSITIONS: dict[str, list[str]] = {
    ...
    "delivered":          ["ready_to_pay", "forwarding", "return_to_supplier", "negotiating", "ignored"],
    "negotiating":        ["ready_to_pay", "return_to_supplier", "ignored"],
    "ready_to_pay":       ["paid", "return_to_supplier", "ignored"],
    "paid":               ["sold", "ignored"],
    "forwarding":         [],
    "return_to_supplier": [],
    "sold":               [],
